  ...
  return (
    <div className={styles.modal}>
      <div className={styles.modalContent}>
        ...
        <h2 className={`mt-6 text-lg text-blue-700 ${inter.className}`}>Términos y condiciones de la Aplicación</h2>
        <p className={`mt-6 text-base leading-8 text-white font-thin ${inter.className}`}>
