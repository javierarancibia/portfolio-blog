    ...
    return (
        <>
            <div className='px-12 mb-10'>
                <h6 className={`text-2xl text-center text-blue-700 font-normal ${inter.className}`}>AUTOMATIZA EL PROCESO DE TASACIÓN DE TU DEPARTAMENTO O EL DE TUS CLIENTES CON ANALÍTICA DE DATOS</h6>
                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        ...
                        <div className="text-center lg:px-10">
                            <div className="text-2xl font-bold tracking-tight text-white sm:text-4xl" style={{marginTop:"2rem"}}>
                                ...
                                <h6> Ahorra tiempo <span className='text-blue-700'>y esfuerzo</span></h6> 
                            ...
                            <div className="text-2xl font-bold tracking-tight text-white sm:text-4xl text-center lg:pl-12" style={{marginTop:"8rem"}}>
                                <BiBarChart className={styles.headerIcons} style={{fontSize:"90px"}} />
                                <h6>Datos actualizados y Algoritmos basadas en <span className='text-blue-700'>Metodologías de tasación tradicional</span></h6>
                            ...
                            <div className="text-2xl font-bold tracking-tight text-white sm:text-4xl text-center lg:pl-12" style={{marginTop:"8rem"}}>
                                <BiBarChart className={styles.headerIcons} style={{fontSize:"90px"}} />
                                <h6>Fácil de Usar y Disponible para <span className='text-blue-700'>Desktop y Móvil</span></h6>
