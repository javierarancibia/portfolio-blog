        ...
        <div className="overflow-hidden lg:pb-5 sm:py-32">
            <div className="mx-auto max-w-7xl py-10 px-6 lg:px-1 md:px-10">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div className="lg:pr-8 lg:pt-4 sm:px-2">
                        <div className="lg:max-w-lg">
                            ...
                            <div className={`mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl ${styles.headerTitle}`}>
                                ...
                                <p className={`mt-6 text-lg leading-8 text-white font-thin ${inter.className}`}>Nuestros algoritmos calculan en cuánto puedes vender tu departamento, generando un informe profesional para ti en solo segundos</p>
                    ...
                    <Image src="/hero.png" height={800} width={800} className={`w-[25rem] max-w-none sm:w-[55rem] md:-ml-4 lg:-ml-0 ${styles.mainImage}`} unoptimized alt="Tasaciones online"  />
                </div>
            </div>
        </div>
    )
