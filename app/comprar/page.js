...
export default async function Comprar() {
  ...
  return (
    <section className="relative flex flex-wrap lg:items-center bg-gray-800">
      <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-12 lg:py-24 lg:-mt-14">
        <div className="mx-auto max-w-md text-center lg:mx-15 lg:flex-auto lg:py-12 lg:text-left">
