...
import BuyButton from "../comprar/BuyButton";
...
export default async function Comprar() {
  ...
  return (
    <section className="relative flex flex-wrap lg:items-center bg-gray-800">
        <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-12 lg:py-24">
            <div className="mx-auto max-w-md text-center lg:mx-15 lg:flex-auto lg:py-32 lg:text-left">
                ...
                <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
                    ...
                    Lamentablemente ocurrió un error en tu compra
                    </span>
                    <br />
                    Te invitamos a que intentes nuevamente la compra de tu informe
                </h2>
        ...
        <div className="relative h-64 w-full sm:h-96 lg:h-full lg:w-1/2 lg:mt-5">
            <Image
                src="/error.png"
                height={1000}
                width={1000}
